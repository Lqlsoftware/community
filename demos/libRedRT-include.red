...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_sqrt: "f_sqrt" [] 
            f_rejoin: "f_rejoin" [] 
            f_ctx192~platform: "f_ctx192~platform" [octx [pointer! [integer!]]] 
            f_ctx217~interpreted?: "f_ctx217~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx228~on-change*: "f_ctx228~on-change*" [octx [pointer! [integer!]]] 
            f_ctx226~on-change*: "f_ctx226~on-change*" [octx [pointer! [integer!]]] 
            f_ctx226~on-deep-change*: "f_ctx226~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx241~throw-error: "f_ctx241~throw-error" [octx [pointer! [integer!]]] 
            f_ctx241~make-time: "f_ctx241~make-time" [octx [pointer! [integer!]]] 
            f_ctx241~to-word: "f_ctx241~to-word" [octx [pointer! [integer!]]] 
            f_ctx241~pop: "f_ctx241~pop" [octx [pointer! [integer!]]] 
            f_ctx241~store: "f_ctx241~store" [octx [pointer! [integer!]]] 
            f_ctx241~transcode: "f_ctx241~transcode" [octx [pointer! [integer!]]] 
            f_ctx261~on-change*: "f_ctx261~on-change*" [octx [pointer! [integer!]]] 
            f_ctx264~on-change*: "f_ctx264~on-change*" [octx [pointer! [integer!]]] 
            f_ctx264~on-deep-change*: "f_ctx264~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx267~eval: "f_ctx267~eval" [octx [pointer! [integer!]]] 
            f_ctx267~eval-reaction: "f_ctx267~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx267~on-stack?: "f_ctx267~on-stack?" [octx [pointer! [integer!]]] 
            f_ctx267~check: "f_ctx267~check" [octx [pointer! [integer!]]] 
            f_clear-reactions: "f_clear-reactions" [octx [pointer! [integer!]]] 
            f_dump-reactions: "f_dump-reactions" [octx [pointer! [integer!]]] 
            f_ctx267~is~: "f_ctx267~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_ctx278~do-quit: "f_ctx278~do-quit" [octx [pointer! [integer!]]] 
            f_ctx278~throw-error: "f_ctx278~throw-error" [octx [pointer! [integer!]]] 
            f_ctx278~syntax-error: "f_ctx278~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx278~do-safe: "f_ctx278~do-safe" [octx [pointer! [integer!]]] 
            f_ctx278~do-code: "f_ctx278~do-code" [octx [pointer! [integer!]]] 
            f_ctx278~count-args: "f_ctx278~count-args" [octx [pointer! [integer!]]] 
            f_ctx278~func-arity?: "f_ctx278~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx278~fetch-next: "f_ctx278~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx278~eval: "f_ctx278~eval" [octx [pointer! [integer!]]] 
            f_ctx278~do-macro: "f_ctx278~do-macro" [octx [pointer! [integer!]]] 
            f_ctx278~register-macro: "f_ctx278~register-macro" [octx [pointer! [integer!]]] 
            f_ctx278~reset: "f_ctx278~reset" [octx [pointer! [integer!]]] 
            f_ctx278~expand: "f_ctx278~expand" [octx [pointer! [integer!]]] 
            ...
            ctx241~make-hm: "ctx241~make-hm" [h [integer!] m [integer!]] 
            ctx241~make-msf: "ctx241~make-msf" [m [integer!] s [float!]] 
            ctx241~make-hms: "ctx241~make-hms" [h [integer!] m [integer!] s [integer!]] 
            ctx241~make-hmsf: "ctx241~make-hmsf" [h [integer!] m [integer!] s [float!]] 
            ctx241~make-binary: "ctx241~make-binary" [start [red-string!] end [red-string!] base [integer!]] 
            ctx241~make-tuple: "ctx241~make-tuple" [start [red-string!] end [red-string!]] 
            ctx241~make-number: "ctx241~make-number" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx241~make-float: "ctx241~make-float" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx241~make-hexa: "ctx241~make-hexa" [start [red-string!] end [red-string!] return: [integer!]] 
            ctx241~make-char: "ctx241~make-char" [start [red-string!] end [red-string!]] 
            ctx241~push-path: "ctx241~push-path" [stack [red-block!] type [red-datatype!]] 
            ctx241~set-path: "ctx241~set-path" [stack [red-block!]] 
            ctx241~make-word: "ctx241~make-word" [src [red-string!] type [red-datatype!]] 
            ctx241~new-line: "ctx241~new-line" [series [cell!]] 
            ctx249~encode: "ctx249~encode" [img [red-image!]] 
            ctx249~decode: "ctx249~decode" [data [cell!]] 
            ctx252~encode: "ctx252~encode" [img [red-image!]] 
            ctx252~decode: "ctx252~decode" [data [cell!]] 
            ctx255~encode: "ctx255~encode" [img [red-image!]] 
            ctx255~decode: "ctx255~decode" [data [cell!]] 
            ctx258~encode: "ctx258~encode" [img [red-image!]] 
            ctx258~decode: "ctx258~decode" [data [cell!]] 
